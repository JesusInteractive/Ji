...
const CATEGORIES: StudyCategory[] = [
  ...
  {
    heading: 'Deliverance & Spiritual Warfare',
    note: 'Classic Protestant writing on spiritual warfare and freedom from demonic influence -- a genre where soundness varies widely across authors. These are the historically significant, widely-cited works, not modern sensationalist material, presented to study from rather than as the app\'s own teaching on the subject.',
    resources: [
      {
        title: 'War on the Saints',
        author: 'Jessie Penn-Lewis with Evan Roberts',
        era: '1912',
        description: 'A widely-read, sometimes-debated classic on spiritual deception and demonic influence, written in the aftermath of the Welsh Revival that Roberts helped lead.',
        url: 'https://www.waronthesaints.org/',
      },
      {
        title: 'The Holy War',
        author: 'John Bunyan',
        era: '1682',
        description: 'An allegory of the town of Mansoul besieged and retaken by the forces of Diabolus and King Shaddai -- Bunyan\'s other great allegory, less famous than Pilgrim\'s Progress but admired by many, including C.S. Lewis, above it.',
        url: 'https://www.gutenberg.org/ebooks/395',
      },
      {
        title: "Precious Remedies Against Satan's Devices",
        author: 'Thomas Brooks',
        era: '1652',
        description: 'A Puritan classic cataloguing the specific tactics of temptation and the specific scriptural remedies for each -- practical, plainspoken pastoral theology.',
        url: 'https://archive.org/details/bim_eighteenth-century_precious-remedies-agains_brooks-thomas_1792',
      },
      {
        title: 'Dæmonologia Sacra: A Treatise of Satan\'s Temptations',
        author: 'Richard Gilpin',
        era: '1677',
        description: 'A 17th-century Puritan pastor\'s systematic study of how temptation and satanic influence work, and how believers are meant to resist them.',
        url: 'https://www.gutenberg.org/ebooks/61249',
      },
    ],
  },
  {
    heading: "Christian Fantasy & Children's Books",
    note: "Imaginative fiction from Christian authors -- allegorical, mythic, or simply adventurous, not meant to be read as doctrine.",
    resources: [
      {
        title: 'Phantastes: A Faerie Romance',
        author: 'George MacDonald',
        era: '1858',
        description: "MacDonald's first full-length fantasy -- a young man's dreamlike journey through Fairy Land -- and the book C.S. Lewis said baptized his imagination.",
        url: 'https://www.gutenberg.org/ebooks/325',
      },
      {
        title: 'The Princess and the Goblin',
        author: 'George MacDonald',
        era: '1872',
        description: 'A young princess and a miner\'s son face goblins living beneath the mountain, guided by the princess\'s mysterious, otherworldly great-great-grandmother.',
        url: 'https://www.gutenberg.org/ebooks/708',
      },
      {
        title: 'The Princess and Curdie',
        author: 'George MacDonald',
        era: '1883',
        description: 'The sequel to The Princess and the Goblin, following Curdie on a quest to save the kingdom from corruption within.',
        url: 'https://www.gutenberg.org/ebooks/709',
      },
      {
        title: 'At the Back of the North Wind',
        author: 'George MacDonald',
        era: '1871',
        description: 'A sickly London boy is carried away on nighttime journeys by North Wind, a beautiful and sometimes fearsome personification of death and providence.',
      ...
      },
      {
        ...
        author: 'George MacDonald',
        era: '1864',
        description: 'A fairy tale about a princess cursed with the total absence of gravity, in both the physical and emotional sense, until love weighs her down.',
        url: 'https://www.gutenberg.org/ebooks/697',
      },
      {
        title: 'Lilith: A Romance',
        author: 'George MacDonald',
        era: '1895',
        description: "MacDonald's darker, stranger final fantasy novel, about a library that opens onto another world and a journey toward death and redemption.",
        url: 'https://www.gutenberg.org/ebooks/1640',
      },
      {
        title: 'The Faery Queen and Her Knights',
        author: 'retold by Alfred J. Church',
        era: 'from Edmund Spenser',
        description: "Edmund Spenser's sprawling 16th-century allegorical epic, retold in accessible prose -- the Redcrosse Knight's quest as an allegory of holiness and the Christian life.",
        url: 'https://www.gutenberg.org/ebooks/55765',
      },
      {
        title: "The Pilgrim's Progress in Words of One Syllable",
        author: 'John Bunyan, retold by Lucy Aikin',
        era: '19th-century children\'s retelling',
        description: "A simplified retelling of Bunyan's allegory for young readers, distinct from the full original text (see Sermons & Devotional Writing above).",
        url: 'https://www.gutenberg.org/ebooks/7088',
      },
      {
        title: 'The Water-Babies',
        author: 'Charles Kingsley',
        era: '1863',
        description: 'A chimney sweep drowns and is transformed into a water-baby in this Victorian fairy tale, one that wraps moral and spiritual lessons around a genuinely strange, dreamlike story.',
      ...
      },
      {
        ...
        author: 'G.K. Chesterton',
        era: '1908',
        description: 'A surreal thriller about an undercover detective infiltrating a council of anarchists, building toward one of Chesterton\'s strangest and most theological endings.',
        url: 'https://www.gutenberg.org/ebooks/1695',
      },
    ],
  },
  {
    heading: 'Christian Women, Motherhood & Family',
    note: '19th-century Protestant writing on womanhood, marriage, and home life -- a snapshot of its era\'s ideals, offered as historical primary sources rather than the app\'s own view on gender roles.',
    resources: [
      {
        title: "The Christian Mother; or, Notes for Mothers' Meetings",
        author: 'Maria Eliza Hoare',
        era: '19th century',
        description: 'Short, practical devotional notes written for gatherings of Christian mothers, on raising children in the faith.',
        url: 'https://www.gutenberg.org/ebooks/42291',
      },
      {
        title: "Female Piety: The Young Woman's Friend and Guide Through Life to Immortality",
        author: 'John Angell James',
        era: '19th century',
        description: 'A widely-read Congregationalist minister\'s guide for young women on cultivating a devout, useful Christian life.',
        url: 'https://archive.org/details/femalepietyoryo00jamegoog',
      },
      {
        title: 'Courtship and Marriage, and the Gentle Art of Home-Making',
        author: 'Annie S. Swan',
        era: '19th century',
        description: 'Practical, warmly-written advice on courtship, marriage, and building a Christian home, from a prolific Scottish novelist.',
        url: 'https://www.gutenberg.org/ebooks/35963',
      },
      {
        title: 'A Treatise on Domestic Economy',
        author: 'Catharine Esther Beecher',
        era: '1841',
        description: "A comprehensive guide to running a Christian household -- health, cooking, child-rearing, and household management -- from a sister of Harriet Beecher Stowe and Henry Ward Beecher.",
        url: 'https://www.gutenberg.org/ebooks/21829',
      },
      {
        title: 'Women in White Raiment',
        author: 'John Lemley',
        era: '1899',
        description: 'Biographical sketches of women throughout the Bible, written to give the "womanhood of the Bible" the same attention usually given its prophets, kings, and priests.',
        url: 'https://www.gutenberg.org/ebooks/69085',
      },
      {
        title: 'Gold Dust: A Collection of Golden Counsels for the Sanctification of Daily Life',
        author: 'ed. Charlotte M. Yonge',
        era: '19th century',
        description: 'Short daily counsels on finding holiness in ordinary tasks and interactions, compiled by a well-known Victorian Anglican novelist.',
        url: 'https://www.gutenberg.org/ebooks/27852',
      },
      {
        title: 'The Wedding Ring',
        author: 'T. De Witt Talmage',
        era: '19th century',
        description: 'A popular preacher\'s practical, plainspoken sermons and reflections on marriage and married life.',
        url: 'https://www.gutenberg.org/ebooks/22343',
      },
      {
        title: 'The Christian Home',
        author: 'Samuel Philips',
        era: '19th century',
        description: 'A devotional and practical guide to building a home centered on Christian faith and family worship.',
        url: 'https://www.gutenberg.org/ebooks/14237',
      },
      {
        title: 'A Christian Directory, Part 2: Christian Economics',
        author: 'Richard Baxter',
        era: '17th century',
        description: "Part of Baxter's massive practical-theology handbook, this section covers duties within marriage, family, and household life.",
        url: 'https://www.gutenberg.org/ebooks/43800',
      },
      {
        title: 'The Works of the Rev. Hugh Binning',
        author: 'Hugh Binning',
        era: '17th century',
        description: 'The collected sermons and treatises of a short-lived but highly regarded Scottish Presbyterian theologian, on Christian faith and practice.',
        url: 'https://www.gutenberg.org/ebooks/24238',
      },
      {
        title: 'A Christian Directory, Part 3: Christian Ecclesiastics',
        author: 'Richard Baxter',
        era: '17th century',
        description: "Another section of Baxter's practical-theology handbook, addressed to pastors and church leaders on their duties.",
        url: 'https://www.gutenberg.org/ebooks/44655',
      },
    ],
  },
  {
    heading: 'Biblical Characters, Patriarchs, Prophets & Mary',
    note: 'Classic public-domain studies of individual figures from Scripture.',
    resources: [
      {
        title: 'Mary: The Queen of the House of David and Mother of Jesus',
        author: 'A. Stewart Walsh',
        era: '19th century',
        description: "A devotional study of Mary's life drawn from the Gospels, respectful of her honored place without venturing beyond what Scripture says of her.",
        url: 'https://www.gutenberg.org/ebooks/60028',
      },
      {
        title: 'Female Scripture Biography',
        author: 'F.A. Cox',
        era: '19th century',
        description: 'Biographical studies of women throughout the Old and New Testaments, by a Baptist minister and college principal.',
        url: 'https://www.gutenberg.org/ebooks/9782',
      },
      {
        title: 'Woman in Sacred History',
        author: 'Harriet Beecher Stowe',
        era: '1873',
        description: "A richly illustrated study of biblical women, from the author of Uncle Tom's Cabin.",
        url: 'https://www.gutenberg.org/ebooks/48872',
      },
      {
        title: 'The Patriarchs',
        author: 'J.G. Bellett',
        era: '19th century',
        description: 'Devotional studies of Adam, Noah, Abraham, and the other patriarchs of Genesis, by an early leader of the Plymouth Brethren movement.',
        url: 'https://www.gutenberg.org/ebooks/40216',
      },
      {
        title: 'Bible Characters',
        author: 'D.L. Moody, Joseph Parker & T. De Witt Talmage',
        era: '19th century',
        description: 'Three of the era\'s most popular preachers each write on biblical figures who caught their attention -- practical, sermon-style character studies.',
        url: 'https://www.gutenberg.org/ebooks/54736',
      },
      {
        title: 'Men of the Bible: Some Lesser-Known Characters',
        author: 'George Milligan and others',
        era: '19th-20th century',
        description: 'Studies of biblical men who rarely get their own chapter -- figures mentioned briefly in Scripture but worth a closer look.',
        url: 'https://www.gutenberg.org/ebooks/13860',
      },
      {
        title: 'Legends of the Patriarchs and Prophets',
        author: 'S. Baring-Gould',
        era: '19th century',
        description: "A collection of later Jewish and Christian legends that grew up around Old Testament figures -- folklore and tradition, not Scripture itself, gathered by an Anglican antiquarian. Presented as a historical curiosity to study from, not as history or as this app's own position.",
        url: 'https://www.gutenberg.org/ebooks/48736',
      },
    ],
  },
  {
    heading: 'Jesus, His Life and Ministry',
    note: 'Classic public-domain studies and retellings of the life of Christ.',
    resources: [
      {
        title: "Hurlbut's Life of Christ For Young and Old",
        author: 'Jesse Lyman Hurlbut',
        era: '20th century',
        description: 'A clear, chronological account of the Gospels\' story of Jesus, from the same author as the popular Story of the Bible (see Children\'s Bible Story Books above).',
        url: 'https://www.gutenberg.org/ebooks/40460',
      },
      {
        title: 'His Life: A Complete Story in the Words of the Four Gospels',
        author: 'William E. Barton and others',
        era: '20th century',
        description: 'The four Gospels harmonized into a single continuous narrative, using only the Gospels\' own words.',
        url: 'https://www.gutenberg.org/ebooks/16184',
      },
      {
        title: 'The Life of Our Lord',
        author: 'Charles Dickens',
        era: 'written 1846-1849, first published 1934',
        description: "Dickens's own simple retelling of the Gospel story, written privately for his children and not published until decades after his death.",
        url: 'https://archive.org/details/lifeofourlordwri011897mbp',
      },
      {
        title: 'The Miracles of Our Lord',
        author: 'George MacDonald',
        era: '1870',
        description: "A devotional study of Jesus's miracles, read by MacDonald not as isolated wonders but as windows into God's character.",
        url: 'https://www.gutenberg.org/ebooks/9103',
      },
    ],
  },
  {
    heading: 'Disciples, John the Baptist, Paul & the Apostles',
    note: 'Classic public-domain studies of the people around Jesus -- his forerunner, his twelve, and the apostle to the Gentiles.',
    resources: [
      {
        title: 'Lives of the Apostles of Jesus Christ',
        author: 'David Francis Bacon',
        era: '1836',
        description: 'Short biographical sketches of each of the twelve apostles, drawing on Scripture and early church tradition.',
        url: 'https://www.gutenberg.org/ebooks/71888',
      },
      {
        title: 'John the Baptist',
        author: 'F.B. Meyer',
        era: '20th century',
        description: "A devotional study of Jesus's forerunner, from a widely-read Baptist pastor known for his character studies of biblical figures.",
        url: 'https://www.gutenberg.org/ebooks/25904',
      },
      {
        title: 'The Life of Jesus Christ for the Young, Volume Four',
        author: 'Richard Newton',
        era: '19th century',
        description: 'The fourth volume of an Episcopal minister\'s popular series retelling the Gospel story for children.',
        url: 'https://www.gutenberg.org/ebooks/67268',
      },
      {
        title: 'The Homilies of the Anglo-Saxon Church, Volume II',
        author: 'Ælfric of Eynsham, trans. Benjamin Thorpe',
        era: '10th century (this translation 1846)',
        description: "The second volume of Ælfric's collected sermons for the church calendar, including his homilies on the feast and passion of Peter -- among the earliest Christian preaching in the English language.",
        url: 'https://archive.org/details/homiliesofanglos02aelfuoft',
      },
      {
        title: 'The Training of the Twelve',
        author: 'A.B. Bruce',
        era: '1871',
        description: "A classic, still-cited study of how Jesus personally discipled the twelve apostles over the course of his ministry.",
        url: 'https://ccel.org/ccel/bruce',
      },
    ],
  },
  {
    heading: 'More Classic Commentaries',
    note: "Further public-domain commentaries beyond the core set above (see Classic Commentaries near the top of this list for Matthew Henry, Calvin, Wesley, Clarke, Barnes, Gill, and Jamieson-Fausset-Brown) -- more specialized or single-book studies, hosted on archive.org rather than ccel.org.",
    resources: [
      {
        title: 'Commentary on the Epistle to the Romans',
        author: 'Charles Hodge',
        era: '1835',
        description: "A landmark Reformed commentary on Romans from Princeton Seminary's leading 19th-century theologian -- his companion commentaries on 1 & 2 Corinthians are also freely available on archive.org under his name.",
        url: 'https://archive.org/details/commentaryonepi00hodggoog',
      },
      {
        title: 'The Greek Testament',
        author: 'Henry Alford',
        era: '19th century',
        description: 'A detailed critical and exegetical commentary on the Greek New Testament text, long a standard reference for pastors and students of Greek.',
        url: 'https://archive.org/details/greektestamentw00alfogoog',
      },
      {
        title: 'Word Studies in the New Testament',
        author: 'Marvin R. Vincent',
        era: '1887',
        description: "A verse-by-verse study of the Greek words behind the New Testament's English text, aimed at readers without formal Greek training.",
        url: 'https://archive.org/details/wordstudiesinne01vincgoog',
      },
      {
        title: 'The Prophecies of Isaiah',
        author: 'Joseph Addison Alexander',
        era: '19th century',
        description: 'A detailed, still-respected 19th-century Princeton commentary on Isaiah, translated and explained verse by verse.',
        url: 'https://archive.org/details/propheciesisaia00eadigoog',
      },
      {
        title: 'The Minor Prophets, with a Commentary',
        author: 'E.B. Pusey',
        era: '19th century',
        description: 'A thorough Oxford commentary covering all twelve Minor Prophets, from a leading figure of the 19th-century Anglican Oxford Movement.',
        url: 'https://archive.org/details/minorprophetswi00pusegoog',
      },
    ],
  },
  {
    heading: 'Christian Biographies: Scientists, Doctors, Athletes & Founders',
    note: 'Public-domain biographies of Christians in science, medicine, athletics, and public life -- a reminder that faith and these fields were never strangers to each other.',
    resources: [
      {
        title: 'Michael Faraday: His Life and Work',
        author: 'Silvanus P. Thompson',
        era: '1898',
        description: 'A biography of the pioneering physicist and chemist, a devout Sandemanian Christian whose faith and scientific work were deeply intertwined.',
        url: 'https://www.gutenberg.org/ebooks/65735',
      },
      {
        title: 'Michael Faraday',
        author: 'J.H. Gladstone',
        era: '1872',
        description: "A shorter biography of Faraday by a chemist and fellow member of his Sandemanian church, published soon after Faraday's death.",
        url: 'https://www.gutenberg.org/ebooks/47396',
      },
      {
        title: 'James Clerk Maxwell and Modern Physics',
        author: 'Richard Glazebrook',
        era: '1896',
        description: 'A biography of the physicist behind electromagnetic theory, an outspoken evangelical Christian throughout his scientific career.',
        url: 'https://www.gutenberg.org/ebooks/65359',
      },
      {
        title: 'The Martyrs of Science',
        author: 'David Brewster',
        era: '1841',
        description: 'The lives of Galileo, Tycho Brahe, and Kepler -- astronomers who suffered for their scientific convictions, from a devout Scottish physicist and inventor of the kaleidoscope.',
        url: 'https://www.gutenberg.org/ebooks/25992',
      },
      {
        title: 'Ministers of Mercy',
        author: 'James H. Franklin',
        era: '1919',
        description: 'Profiles of Christian medical missionaries around the world in the early 20th century.',
        url: 'https://archive.org/details/ministersofmercy00fran_0',
      },
      {
        title: 'The Personal Life of David Livingstone',
        author: 'W. Garden Blaikie',
        era: '1880',
        description: 'A detailed biography of the missionary-explorer of Africa, drawing on his private letters and journals.',
        url: 'https://www.gutenberg.org/ebooks/13262',
      },
      {
        title: 'Eminent Doctors: Their Lives and Their Work',
        author: 'George Thomas Bettany',
        era: '1885',
        description: 'Biographical sketches of notable physicians through history, several of them openly Christian in their motivations for medicine.',
        url: 'https://archive.org/details/eminentdoctorsth01bett_0',
      },
      {
        title: 'Gil Dodds, The Flying Parson',
        author: 'Mel Larson',
        era: '1945',
        description: 'A biography of the world-record-holding miler who was also an ordained minister, written by a Youth for Christ staff writer.',
        url: 'https://archive.org/details/gildoddsflyingp00chrigoog',
      },
      {
        title: 'Pioneers and Founders',
        author: 'Charlotte M. Yonge',
        era: '1871',
        description: 'Biographical sketches of missionaries who founded new Christian work in unfamiliar lands, from a popular Victorian novelist.',
        url: 'https://www.gutenberg.org/ebooks/19308',
      },
      {
        title: 'Beacon Lights of History, Volume XI: American Founders',
        author: 'John Lord',
        era: '19th century',
        description: "Biographical lectures on the founders of early America, from a popular 19th-century Congregationalist historian and lecturer.",
        url: 'https://www.gutenberg.org/ebooks/10644',
      },
      {
        title: 'Lives of Poor Boys Who Became Famous',
        author: 'Sarah Knowles Bolton',
        era: '1885',
        description: 'Short biographies of well-known men who grew up in poverty, written to encourage character and perseverance in young readers.',
        url: 'https://www.gutenberg.org/ebooks/35950',
      },
      {
        title: 'The True George Washington',
        author: 'Paul Leicester Ford',
        era: '1896',
        description: "A biography aiming past the legends (the cherry tree, the silver dollar) to Washington's actual character and daily life.",
        url: 'https://www.gutenberg.org/ebooks/12300',
      },
      {
        title: 'Abraham Lincoln, the Christian',
        author: 'William J. Johnstone',
        era: '1913',
        description: "An account of Lincoln's religious life and beliefs, a subject historians still debate given how little Lincoln wrote about it directly.",
        url: 'https://archive.org/details/abrahamlincoln00john',
      },
      {
        title: 'A Library of Christian Biography, Volume I',
        author: 'Thomas Jackson',
        era: '1838',
        description: 'The first volume of a Methodist minister\'s multi-volume collection of biographies of notable Christians through history.',
        url: 'https://archive.org/details/in.ernet.dli.2015.200822',
      },
    ],
  },
  {
    heading: 'Bible Translators',
    note: 'Public-domain histories and biographies about the people and process behind putting the Bible into English.',
    resources: [
      {
        title: 'The Translators Revived: A Biographical Memoir of the Authors of the King James Version',
        author: 'A.W. McClure',
        era: '1853',
        description: 'Short biographies of the 47 scholars who translated the King James Bible, most of whom are otherwise almost entirely forgotten.',
        url: 'https://archive.org/details/translatorsreviv00mccl',
      },
      {
        title: 'William Tyndale, a Biography',
        author: 'Robert Demaus',
        era: '1871',
        description: "A detailed 19th-century biography of the first English translator to work directly from the Greek and Hebrew (see also Tyndale's own writings under Sermons & Devotional Writing above).",
        url: 'https://archive.org/details/williamtyndalea00demagoog',
      },
      {
        title: 'Lectures on Bible Revision',
        author: 'Samuel Newth',
        era: '1881',
        description: 'A firsthand account of the process behind the Revised Version of the Bible, by one of the scholars who worked on it.',
        url: 'https://www.gutenberg.org/ebooks/42514',
      },
      {
        title: 'The History of the English Bible',
        author: 'John Brown',
        era: '1911',
        description: 'A concise survey of how the Bible came into English, from Wycliffe and Tyndale through the King James and Revised Versions.',
        url: 'https://archive.org/details/englishbible00browuoft',
      },
      {
        title: 'The Bible in the Church',
        author: 'Brooke Foss Westcott',
        era: '1864',
        description: "A study of how the biblical canon itself took shape and was received across the early Christian centuries, from a bishop and New Testament textual scholar.",
        url: 'https://archive.org/details/bibleinchurchap00westgoog',
      },
    ],
  },
  {
