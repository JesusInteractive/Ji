...
const styles = StyleSheet.create({
  ...
  // 140, down from 200: the photo was crowding the page; the greeting
  // under it carries the page instead.
  ...
  photoName: { fontSize: 28, fontWeight: '800', color: Colors.royal, marginTop: 12, textAlign: 'center' },
