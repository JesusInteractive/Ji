...
export const USER_AGREEMENT = {
  ...
  sections: [
    ...
    },
    {
      ...
      body:
        'The App may integrate or link to third-party services (AI providers, Bible content providers, payment processors, analytics, SMS delivery for the Emergency SOS feature). Your use of those services is subject to their own terms and privacy policies. We are not responsible for third-party services.',
    },
    {
