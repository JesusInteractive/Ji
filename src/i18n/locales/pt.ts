...
const pt: TranslationShape = {
  ...
  "studyLibrary": {
    ...
    "libraryTitle": "Biblioteca de Estudos",
    "pickABook": "Escolha um livro da estante.",
    "readAloudCaseTitle": "Livros que Jesus lê em voz alta",
    "readingStatus": "Jesus está lendo {title}",
    "narratingStatus": "Lendo agora: {title}",
    "pausedStatus": "Pausado: {title}",
    "finishedStatus": "Fim de {title}.",
    ...
    "readAlong": "Acompanhar a leitura",
    "putBack": "Devolver o livro à estante",
    "pageOf": "Página {page} de {total}",
    "tryAgain": "Tentar novamente",
    "readingError": "A leitura parou. Verifique sua conexão e tente novamente.",
    "textOnlyNote": "Jesus ainda não pode ler este em voz alta. Você pode lê-lo na fonte original.",
    "openAtSource": "Abrir na fonte",
    "platinumNote": "Jesus lê estes livros em voz alta para membros Platinum. Você ainda pode ler o texto.",
    "seePlatinum": "Ver Platinum",
    "subscribeNote": "Assine para abrir os livros de Leitura em Voz Alta.",
    "subscribe": "Assinar",
    "readTheText": "Ler o texto",
    "legendJesus": "A IA Jesus lê",
    "legendScholar": "O Estudioso lê",
    "jesusVoiceTag": "Lido pela IA Jesus",
    "scholarVoiceTag": "Lido pelo Estudioso",
    "scholarReadingStatus": "O Estudioso está lendo {title}",
    "scholarPlatinumNote": "O Estudioso lê estes livros em voz alta para membros Platinum. Você ainda pode ler o texto.",
    "scholarDisclosure": "O Estudioso é uma voz de IA modelada para este app — não uma gravação de uma pessoa real."
  }
};
