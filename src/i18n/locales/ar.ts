...
const ar: TranslationShape = {
  ...
  "studyLibrary": {
    ...
    "libraryTitle": "مكتبة الدراسة",
    "pickABook": "اختر كتابًا من الرف.",
    "readAloudCaseTitle": "كتب يقرؤها يسوع بصوت عالٍ",
    "readingStatus": "يسوع يقرأ {title}",
    "narratingStatus": "يُقرأ الآن: {title}",
    "pausedStatus": "متوقف مؤقتًا: {title}",
    "finishedStatus": "نهاية {title}.",
    ...
    "readAlong": "اقرأ معه",
    "putBack": "أعد الكتاب إلى الرف",
    "pageOf": "صفحة {page} من {total}",
    "tryAgain": "حاول مرة أخرى",
    "readingError": "توقفت القراءة. تحقق من اتصالك وحاول مرة أخرى.",
    "textOnlyNote": "لا يستطيع يسوع قراءة هذا الكتاب بصوت عالٍ بعد. يمكنك قراءته من المصدر.",
    "openAtSource": "افتح في المصدر",
    "platinumNote": "يقرأ يسوع هذه الكتب بصوت عالٍ لأعضاء بلاتينوم. لا يزال بإمكانك قراءة النص.",
    "seePlatinum": "عرض بلاتينوم",
    "subscribeNote": "اشترك لفتح كتب القراءة بصوت عالٍ.",
    "subscribe": "اشترك",
    "readTheText": "اقرأ النص",
    "legendJesus": "يقرؤه يسوع الذكاء الاصطناعي",
    "legendScholar": "يقرؤه الباحث",
    "jesusVoiceTag": "بقراءة يسوع الذكاء الاصطناعي",
    "scholarVoiceTag": "بقراءة الباحث",
    "scholarReadingStatus": "الباحث يقرأ {title}",
    "scholarPlatinumNote": "يقرأ الباحث هذه الكتب بصوت عالٍ لأعضاء بلاتينوم. لا يزال بإمكانك قراءة النص.",
    "scholarDisclosure": "الباحث صوت بالذكاء الاصطناعي مصمم لهذا التطبيق — وليس تسجيلاً لشخص حقيقي."
  }
};
