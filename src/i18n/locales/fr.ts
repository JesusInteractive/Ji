...
const fr: TranslationShape = {
  ...
  "studyLibrary": {
    ...
    "libraryTitle": "Bibliothèque d'études",
    "pickABook": "Choisissez un livre sur l'étagère.",
    "readAloudCaseTitle": "Livres que Jésus lit à voix haute",
    "readingStatus": "Jésus lit {title}",
    "narratingStatus": "Lecture en cours : {title}",
    "pausedStatus": "En pause : {title}",
    ...
    "slower": "Plus lent",
    "normalSpeed": "Normal",
    "readAgain": "Relire ce passage",
    "readAlong": "Suivre le texte",
    "putBack": "Remettre le livre en place",
    "pageOf": "Page {page} sur {total}",
    "tryAgain": "Réessayer",
    "readingError": "La lecture s'est arrêtée. Vérifiez votre connexion et réessayez.",
    "textOnlyNote": "Jésus ne peut pas encore lire ce livre à voix haute. Vous pouvez le lire à la source.",
    "openAtSource": "Ouvrir à la source",
    "platinumNote": "Jésus lit ces livres à voix haute pour les membres Platinum. Vous pouvez tout de même lire le texte.",
    "seePlatinum": "Voir Platinum",
    "subscribeNote": "Abonnez-vous pour ouvrir les livres Lecture à voix haute.",
    "subscribe": "S'abonner",
    "readTheText": "Lire le texte",
    "legendJesus": "L'IA Jésus le lit",
    "legendScholar": "L'Érudit le lit",
    "jesusVoiceTag": "Lu par l'IA Jésus",
    "scholarVoiceTag": "Lu par l'Érudit",
    "scholarReadingStatus": "L'Érudit lit {title}",
    "scholarPlatinumNote": "L'Érudit lit ces livres à voix haute pour les membres Platinum. Vous pouvez tout de même lire le texte.",
    "scholarDisclosure": "L'Érudit est une voix d'IA modélisée pour cette application — et non un enregistrement d'une personne réelle."
  }
};
